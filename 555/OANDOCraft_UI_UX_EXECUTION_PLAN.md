...
- [x] Audit every block/object type on the sample office.
- [x] Define visual hierarchy for structure vs furniture vs people data.
- [x] Improve desk/seat block styling.
- [x] Improve room block styling.
- [x] Improve neighborhood styling.
- [x] Improve selected and hover states.
- [x] Improve assigned/unassigned states.
- [x] Add zoom-aware label rules.
- [x] Verify readability at 50%, 100%, and 150% zoom.
- [x] Verify light theme canvas.
- [x] Verify dark theme canvas.
...
- [x] Verify 2.5D opens from the active browser window.
- [x] Verify 2.5D opens from a fresh browser/session.
- [x] Verify return to 2D works.
- [x] Verify floor switching in 2.5D.
- [x] Improve 3D block proportions.
- [x] Improve 3D colors/materials.
- [x] Improve lighting and shadows.
- [x] Improve camera presets.
- [x] Add polished loading state.
- [x] Add polished unavailable state.
- [x] Confirm 2.5D does not feel like broken or unfinished UI.
...
- [x] Simplify roster stats area.
- [x] Collapse advanced filters.
- [x] Improve quick filters.
- [x] Promote show-on-map action.
- [x] Improve redacted-mode copy.
- [x] Add empty search/filter state.
- [x] Check list view.
- [x] Check card view.
- [x] Check roster-to-map handoff.
...
- [x] Test 1280px width.
- [x] Test 1440px width.
- [x] Confirm no toolbar overlap.
- [x] Confirm no text overflow.
- [x] Confirm canvas controls remain reachable.
- [x] Confirm roster remains readable.
...
- [x] Review login page layout.
- [x] Review signup page layout.
- [x] Review forgot/reset password states.
- [x] Review verification state.
- [x] Check auth error messages.
- [x] Check auth loading state.
- [x] Check post-login redirect.
- [x] Check team onboarding copy.
- [x] Check account/profile page hierarchy.
- [x] Check auth pages on mobile.
...
- [x] Audit help page structure.
- [x] Rename demo/help CTAs where needed.
- [x] Add product-surface links from relevant help sections.
- [x] Improve help sidebar scanability.
- [x] Check help page mobile layout.
- [x] Confirm help does not block demo discovery.
...
- [x] Review reports page hierarchy.
- [x] Review insights/report cards.
- [x] Review audit log filters.
- [x] Review audit empty state.
- [x] Review reservations page.
- [x] Review scenarios page.
- [x] Check table density.
- [x] Check secondary page mobile behavior.
...
- [x] Review team settings general page.
- [x] Review members page.
- [x] Review invite states.
- [x] Review role labels.
- [x] Review empty member/invite states.
- [x] Review destructive action styling.
- [x] Check settings on mobile.
