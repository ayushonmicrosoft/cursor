...
export const ELEMENT_DEFAULTS: Record<string, { width: number; height: number; fill: string; stroke: string }> = {
  ...
  'monitor':    { width: 42,  height: 26, fill: '#0F172A', stroke: '#475569' },
  'task-lamp':  { width: 36,  height: 36, fill: '#FACC15', stroke: '#854D0E' },
  'credenza':   { width: 150, height: 46, fill: '#D6B884', stroke: '#7C4A1D' },
  'bookshelf':  { width: 90,  height: 28, fill: '#B7791F', stroke: '#6B3F16' },
  'area-rug':   { width: 160, height: 100, fill: '#DBEAFE', stroke: '#2563EB' },
}
