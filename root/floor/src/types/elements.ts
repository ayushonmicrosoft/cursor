...
export type CatalogQualityTier = 'standard' | 'premium-ready'
export type FurnitureAssetSource = 'built-in-vector' | 'glb-ready'
export type FurnitureAssetLicense = 'built-in' | 'CC0' | 'CC-BY' | 'custom'
...
export interface MonitorElement extends BaseElement {
  type: 'monitor'
}

export interface TaskLampElement extends BaseElement {
  type: 'task-lamp'
}

export interface CredenzaElement extends BaseElement {
  type: 'credenza'
}
...
export interface AreaRugElement extends BaseElement {
  type: 'area-rug'
}
...
export function isMonitorElement(el: CanvasElement): el is MonitorElement {
  return el.type === 'monitor'
}

export function isTaskLampElement(el: CanvasElement): el is TaskLampElement {
  return el.type === 'task-lamp'
}
...
export function isBookshelfElement(el: CanvasElement): el is BookshelfElement {
  return el.type === 'bookshelf'
}

export function isAreaRugElement(el: CanvasElement): el is AreaRugElement {
  return el.type === 'area-rug'
}
