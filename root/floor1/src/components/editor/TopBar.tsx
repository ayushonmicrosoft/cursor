...
import {
  ...
  ChevronDown, Eye, Check, Share2, Download, Hash, Box,
} from 'lucide-react'
...
export function TopBar() {
  ...
  const { setShareModalOpen, setExportDialogOpen, setPresentationMode, presentationMode, selectedIds, clearSelection, setThreeDMode } = useUIStore(useShallow((s) => ({ setShareModalOpen: s.setShareModalOpen, setExportDialogOpen: s.setExportDialogOpen, setPresentationMode: s.setPresentationMode, presentationMode: s.presentationMode, selectedIds: s.selectedIds, clearSelection: s.clearSelection, setThreeDMode: s.setThreeDMode })))
  ...
  return (
    <div className="h-14 bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-800 flex items-center px-4 gap-3 flex-shrink-0 overflow-x-auto whitespace-nowrap no-scrollbar">
      {/* ───── Identity cluster ─────
