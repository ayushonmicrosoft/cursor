import { AlertTriangle, Armchair, Building2, Cloud, Users } from 'lucide-react'
...
export function AdminStatsToolbar() {
  ...
  }, [elements, employees, floors.length, insights])
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-gray-200/80 dark:border-gray-800/80 px-3 py-2">
        <div className="flex items-center justify-between rounded-lg border border-gray-200/80 bg-gradient-to-r from-white to-[#f4efe8] px-3 py-2 text-xs dark:border-gray-800 dark:from-gray-900 dark:to-[#1b2940]">
...
function StatCard({
  ...
  return (
    <div className={`rounded-xl border border-gray-200/80 bg-gradient-to-br from-white to-[#f7f2ec] p-3 shadow-sm dark:border-gray-800 dark:from-gray-900 dark:to-[#12233a] ${accentClass ?? ''}`}>
